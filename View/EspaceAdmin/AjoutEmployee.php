            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header card-header-primary">
                        ...
                        <p class="card-category">Ajouter un nouvelle Employee</p>
                    </div>
                    <div class="card-body">
                        <form method="post" action="../../Controller/EmployeController/AjoutEmployee.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name = "tel" type="number" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select  name = "sexe" class="browser-default custom-select" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Mote de Passe</label>
                            ...
                            <button name = "submit" type="submit" class="btn btn-primary pull-right">Ajouter</button>
                            <div class="clearfix"><?php if(isset($_GET['message']))
                            {
                                if( $_GET['message'] == "succes")
                                {
                                    ?>
                                    <label style="color: limegreen"><h4> <?php echo "Employe ajouter avec ".  $_GET['message'] ?></h4></label>
                               ...
                               <?php
                                ...
                                {
                                    ?>
                                    <label style="color: red" ><?php  echo $_GET['message'] ?></label>
